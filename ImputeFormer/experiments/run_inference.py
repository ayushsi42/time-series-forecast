...
def load_model(exp_dir, exp_config, dm, time_emb_dim=0):
...
def run_experiment(args):
    ...
    # time embedding
    time_emb = None
    if is_spin or args.model_name in ['transformer', 'spin', 'gconv_transformer']:
    ...
    imputer = load_model(exp_dir, exp_config, dm, time_emb_dim)
    print(imputer)
